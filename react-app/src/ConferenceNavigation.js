          ...
          <div className="container">
            <div className="columns is-vcentered">
              <div className="column">
                <p className="title">Conference planner</p>
            ...
            <nav className="tabs is-boxed">
              <ul>
                <li className={pathname === '/' ? 'is-active' : ''}>
                  <a onClick={() => push('/')}>Conferences</a>
                </li>
                <li
                  className={
                    pathname === '/secure/conferences' ? 'is-active' : ''
                  }
                >
                  <a onClick={() => push('/secure/conferences')}>
                    Conference Management
                  </a>
                </li>
                <li className={pathname === '/secure/talks' ? 'is-active' : ''}>
                  <a onClick={() => push('/secure/talks')}>Talks management</a>
                </li>
              </ul>
            </nav>
          </div>
