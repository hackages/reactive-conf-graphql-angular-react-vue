...
export const isDateBefore = propertyKey =>
  withParams({ type: "isDateBefore", key: propertyKey }, function(
    value,
    parentVm
  ) {
...
export const isDateAfter = propertyKey =>
  withParams({ type: "isDateAfter", key: propertyKey }, function(
    value,
    parentVm
  ) {
    const siblingValue = parentVm[propertyKey];
