    ...
    <div class="container">
      <div class="columns">
        <div class="column">
          ...
          <hr>
          <br>
          <p class="title is-4">Talks :</p>
          <!--Conference talks-->
          <div class="columns" v-for="talks in talkChunk">
            <div class="column is-6" v-for="talk in talks" :key="$index">
              <cp-talk-card :talk="talk"></cp-talk-card>
            </div>
          </div>
          <hr>
          <p class="title is-4">Speakers :</p>
          <!--Conference Speakers-->
          <div class="columns" v-for="speakersChunk in speakerChunk">
            <div class="column is-6" v-for="speaker in speakersChunk" :key="speaker">
              <cp-speaker-card :speaker="speaker"></cp-speaker-card>
            </div>
          </div>
          <hr>
          <!--Conference sponsors-->
          <p class="title is-4 is-spaced">Sponsors :</p>
